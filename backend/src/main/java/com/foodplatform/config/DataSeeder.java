...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        String[][] restaurantData = {
            ...
            { "Le Petit Bistro", "Classic French bistro fare — escargot, coq au vin, and fine pastries", "French", "404 Bistro Lane, Uptown", "https://images.unsplash.com/photo-1550966871-3ed3cdb51f3a?w=800", "4.8" },
